...
def name_changer():
    with open("/Users/keyglock/Documents/python/CryptoApe/csv/CoinGecko Token API List - CoinGecko Token API List.csv", mode="r") as csv_data:
    ...
    with open("/Users/keyglock/Documents/python/CryptoApe/csv/CG_token_list.csv", "w", encoding="ISO-8859-1", newline="") as file:
...
async def categories_list_changer():
    ...
    async with aiohttp.ClientSession() as session:
        ...
        with open("/Users/keyglock/Documents/python/CryptoApe/csv/CG_categories_list.csv", "w", encoding="ISO-8859-1", newline="") as file:
            write = csv.writer(file)
...
if __name__ == '__main__':
    # print(name_changer())
    asyncio.run(print(categories_list_changer()))