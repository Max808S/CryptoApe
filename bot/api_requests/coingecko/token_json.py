...
def name_changer():
    ...
    result = "[*] Original and new names are written to a new CSV file!"
    return result


# EXAMPLE: tron-eth - tron_eth
with open("CG_token_list.csv", mode="r") as csv_data:
    reader = csv.reader(csv_data)
...
with open('CoinGecko_Token_API_List_-_CoinGecko_Token_API_List.csv', mode='r') as extra_csv_data:
...
#     print(cg_categories_values)
#     name_changer()
    # print(type(extra_dict_from_tokens_csv.items()))
    # print(type(extra_cg_token_values))
