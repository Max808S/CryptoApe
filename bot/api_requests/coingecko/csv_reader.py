...
with open("/Users/keyglock/Documents/python/CryptoApe/csv/CG_categories_list.csv", mode="r") as cg_categories_csv_data:
# with open("/root/TgBot/test/CryptoApe/csv/CG_categories_list.csv", mode="r") as cg_categories_csv_data:
...
with open("/Users/keyglock/Documents/python/CryptoApe/csv/CG_token_list.csv", mode="r") as csv_data:
# with open("/root/TgBot/test/CryptoApe/csv/CG_token_list.csv", mode="r") as csv_data:
...
# EXAMPLE: bitcoin - btc
with open("/Users/keyglock/Documents/python/CryptoApe/csv/CoinGecko_Token_API_List_-_CoinGecko_Token_API_List.csv", mode="r") as csv_data:
# with open("/root/TgBot/test/CryptoApe/csv/CoinGecko_Token_API_List_-_CoinGecko_Token_API_List.csv", mode="r") as csv_data:
    reader = csv.reader(csv_data)
...
with open("/Users/keyglock/Documents/python/CryptoApe/csv/CoinGecko_Token_API_List_-_CoinGecko_Token_API_List.csv", mode="r") as extra_csv_data:
# with open("/root/TgBot/test/CryptoApe/csv/CoinGecko_Token_API_List_-_CoinGecko_Token_API_List.csv", mode="r") as extra_csv_data:
